...
const EventDetailsWidget: React.FC<EventDetailsWidgetProps> = ({ data }) => {
  ...
  return (
    <div className="h-full flex flex-col p-3">
      <h3 className="font-medium widget-text text-lg mb-4 flex items-center">
        <Calendar className="mr-2 h-5 w-5 text-blue-500" />
        {eventTitle}
      </h3>
      
      <div className="space-y-3 flex-grow">
        <div className="flex items-center text-sm widget-text-muted">
        ...
        {eventLocation && (
          <div className="flex items-center text-sm widget-text-muted">
            <MapPin className="mr-2 h-4 w-4 widget-text-muted" />
